...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ ...newErrors, general: 'Connection error. Please try again later.' });
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Login to tenantli to secure your rental deposit" />
      ...
      >
        ...
        <div className="w-full flex flex-col items-center px-[5%] pt-[85px]">
          ...
          <form id="loginForm" onSubmit={handleSubmit} className="w-full max-w-[350px] sm:max-w-[400px] lg:max-w-[420px]">
            {/* Email Input */}
            <div className="mb-4">
            ...
            {/* Password Input */}
            <div className="mb-4">
              <div className={`relative w-full h-[56px] flex flex-row items-center px-[20px] py-[18px] gap-[8px] ${focusedField === 'password' ? 'bg-[#E8F5EB] border-[#55A363]' : errors.password ? 'bg-red-50 border-red-300' : 'bg-white border-[#D1E7D5]'} border rounded-[16px] transition-all duration-200`}>
                <KeyIcon />
                <input
                  id="password"
                  name="password"
        ...
        {/* Submit Button - Bottom of screen */}
        <button
          type="submit"
          form="loginForm"
