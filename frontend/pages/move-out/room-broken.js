...
export default function MoveOutRoom() {
  ...
  const { propertyId, roomId, returnUrl, isReport } = router.query;
  
  console.log('[DEBUG] Query params:', { propertyId, roomId, returnUrl, isReport });
  ...
  const isReadOnly = isReport === 'true';
